    ...
    fun retirementCalculatorTest() {
        ...
        val textView = onView(
            allOf(
                ...
                withText("At the current rate of 3.0%, saving $200.0 a month you will have $177225.343750 by 65."),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
        ...
        textView.check(matches(withText("At the current rate of 3.0%, saving $200.0 a month you will have $177225.343750 by 65.")))
    }
